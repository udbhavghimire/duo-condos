    ...
    <header class="header-transparent " id="header">
      ...
      <svg width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="hero-container" data-aos="fade-up">
            <video autoplay loop muted playinline id="myvideo" class="w-100 position-absolute" preload="auto">
                <source src="images/duo_website_landing_page_loop-1080p.mp4" type="video/mp4">
              </video>
            <a href="#about" class="btn-get-started scrollto d-flex justify-content-center align-items-center d-none d-md-block"><i class="bi bi-chevron-double-down"></i></a>
        </div>
    </section> -->
                                ...
                                <div class="pt-2 pt-sm-2 pt-md-2 rounded-mine mt-3 px-3" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                                    ...
                                    <h2 class="headline-textt headline-textt-sm">
                                        ...
                                        <div class="list d-block headline-textt pt-4">
                                            ...
                                            <p class="mybot pb-md-0 pb-0 ">
                                                Address: 245 Steeles Avenue West, Brampton
                                            </p>
                                            <p class="mybot pb-md-0 pb-0 ">
                                                Pricing : Starting From $500'S
                                            </p>
        ...
        <section class="pt-5 ">
            <div class="container pt-5" id="Features">
                <div class="row me-0 row-cols-1 row-cols-md-2 mx-3 d-flex justify-content-center align-items-center">
                    <div class="col border-left d-flex justify-content-center align-items-center">
                        <div class="py-4 px-md-4 ">
                            <h2 class="fw-bold fs-2 ex-boldd">
                                Deposit Structure
                            </h2>
                            <div>

                                <ul class="mt-3 mylist headline-text ">
                                    <li class="border-0 ">
                                        $5,000 on Signing
                                    </li>
                                    <li class="border-0 ">
        ...
        <section>
            <div class="container " id="location">
                <div class="pt-md-5 pt-5 mt-md-5"></div>
                <div class="py-5 ">
                ...
                <div class="pt-5 mt-5 " data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                    <div class="row mx-0 ">
                        <div class="text-center pt-3 ">
                            <img src="images/duo-logo1.png" class="img-fluid regoimg " alt="Empire Communities Logo ">
                        </div>
                        ...
                        <div class="registertext px-4 d-flex justify-content-center align-items-center text-center ">
                            <p>Register today and get the update on DUO Condos coming up in Brampton
                            </p>
                        </div>
        ...
        <footer class="footerr py-5 mb-4 bg-light">
            <div class="container ">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5  d-flex justify-content-around ">
                    ...
                    <div class="col-md-4 mt-md-3 py-md-5 py-4 center-sm px-5 d-flex justify-content-around">
                        <div>
                            <h5 class="text-dark fw-bold  mb-3 ">About Duo Condo</h5>
                            <div class="list d-block ">
                                <p class="mybot ">
                                    Builder : National Homes and Brixen Developments Inc.
                                </p>
                                <p class="mybot ">
                                    Location : 3245 Steeles Avenue West, Brampton, ON
                                </p>
